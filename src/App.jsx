...
function App() {
  ...
  const categorias = {
    ...
    "Cabos Variados": [{ nome: "Cabo P2/P2", preco: "R$ 10,00" }],
    ...
    TVs: [
      ...
      { nome: "controle", preco: "R$ 18,00" },
    ],

    "Copos e Garrafas": [{ nome: "Copo Stanley", preco: "R$ 45,00" }],

    Balanças: [{ nome: "Balança Digital Cozinha 10kg", preco: "R$ 45,00" }],

    Projetores: [{ nome: "Mini Projetor", preco: "R$ 250,00" }],
    ...
    Lanternas: [{ nome: "Lanterna LED KV-564", preco: "R$ 80,00" }],
    ...
    Campainha: [{ nome: "Campainha Lukton ", preco: "R$ 45,00" }],

    "Microfone ": [{ nome: "Microfone sem fio MK-12 ", preco: "R$ 60,00" }],
  };
